                ...
                <table
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="d-none d-sm-table-cell text-center" style="width: 5%;">paket wisata</th>
                ...
                <div class="block-content">
                    <form action="" name="frm_detail" id="frm_detail" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control input-currency" type-currency="IDR" id="harga_hotel"
                                name="harga_hotel" placeholder="Rp">
                        </div>
                        <div class="form-group ">
